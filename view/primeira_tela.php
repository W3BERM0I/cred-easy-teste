  ...
  <main>
    <div class="caixa">
      ...
      <div class="caixa__imagem">
        <img src="/assets/img/Credit-card-bro.svg" alt="referencia a creditos">
      </div>
    </div>
  </main>
  <div class="solucoes">
    <div class="solucoes__cred">
      ...
      <p class="solucoes__texto">Voce esta pensando em ampliar o seu negocio mas esta sem capital, venha conhecer as nossas soluções com juros baixos e sem burocracia</p>
