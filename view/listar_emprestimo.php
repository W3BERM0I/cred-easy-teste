...
<body>
  ...
  <main>
    <div class="lista_emprestimos">
      ...
      <table class="table table-borderless">
        ...
        <tbody>
          <?php foreach ($emprestimos as $emprestimo) { ?>
            <tr>
              <th scope="row"><?php echo $emprestimo->getId(); ?></th>
      ...
      <div class="c">
        <div class="cria_emprestimos"><a class="bnovo" href="/solicitar-emprestimo">Solicitar novo emprestimo</a></div>
      </div>
    </div>
  </main>
